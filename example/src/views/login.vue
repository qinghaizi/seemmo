  ...
  <div class="login">
    ...
    <div class="login-box">
      ...
      >
        ...
        <el-form-item>
          <el-button type="success" @click="checkpwd" style="width:100%;"
            >登录</el-button
          >
        </el-form-item>
      </el-form>
      <el-row v-show="isLogin">
        <el-row style="line-height:150px;text-align:center;"
          >你已经登录!</el-row
        >
        <el-button type="success" icon="el-icon-edit" @click="toIndex">
          直接进入</el-button
        >
        <el-button type="primary" icon="el-icon-sort" @click="logOut"
          >切换账号</el-button
        >
      </el-row>
    </div>
