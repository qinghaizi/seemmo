      ...
      <el-row v-show="level === 1">
        ...
        <el-row>
          <el-col :span="8">
            <el-button
              @click="
                showPopView({ positioning: 'top-left' }, (offset = [0, 0]))
              "
              >左上</el-button
            >
          </el-col>
          <el-col :span="8">
            <el-button
              @click="
                showPopView({ positioning: 'top-center' }, (offset = [0, 0]))
              "
              >正上</el-button
            >
          </el-col>
          <el-col :span="8">
            <el-button
              @click="
                showPopView({ positioning: 'top-right' }, (offset = [0, 0]))
              "
              >右上</el-button
            >
          </el-col>
        ...
        <el-row>
          <el-col :span="8">
            <el-button
              @click="
                showPopView({ positioning: 'center-left' }, (offset = [0, 0]))
              "
              >正左</el-button
            >
          </el-col>
          <el-col :span="8">
            <el-button
              @click="
                showPopView({ positioning: 'center-center' }, (offset = [0, 0]))
              "
              >中间</el-button
            >
          </el-col>
          <el-col :span="8">
            <el-button
              @click="
                showPopView({ positioning: 'center-right' }, (offset = [0, 0]))
              "
              >正右</el-button
            >
          </el-col>
        ...
        <el-row>
          <el-col :span="8">
            <el-button
              @click="
                showPopView({ positioning: 'bottom-left' }, (offset = [0, 0]))
              "
              >左下</el-button
            >
          </el-col>
          <el-col :span="8">
            <el-button
              @click="
                showPopView({ positioning: 'bottom-center' }, (offset = [0, 0]))
              "
              >正下</el-button
            >
          </el-col>
          <el-col :span="8">
            <el-button
              @click="
                showPopView({ positioning: 'bottom-right' }, (offset = [0, 0]))
              "
              >右下</el-button
            >
          </el-col>
...
export default {
  ...
  methods: {
    ...
    showPopView ({ positioning = this.positioning, offset = [0, 0] } = {}) {
      ...
      if (!this.seePop) {
        this.seePop = new SeePop({ positioning, offset }, popView).addTo(
